...
I<Reflection> is the process of asking a program about itself as it runs.  Even
though you can write many useful programs without ever having to use
...
=head3 Checking that a Package Exists
...
=head3 Checking that a Class Exists
...
=head3 Checking that a Module Has Loaded
...
=head3 Checking the Version of a Module
...
=head3 Checking that a Function Exists
...
=head3 Checking that a Method Exists
...
=head3 Rooting Around in Symbol Tables
