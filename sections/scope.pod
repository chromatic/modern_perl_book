...
current lexical scope.  Thus, C<$scope> contains C<main() scope> within the body of
...
You may only C<local>ize global and package global variables.  You cannot
C<local>ize lexical variables.
