...
Since Perl 5.10.0, generalized hooks to implement lexical pragmas are
available.  They are accessible directly from Perl code.  

See C<perldoc perlpragma> for instructions to write your own pragmas.
If you're interested in learning how it all works behind the scenes,
the place to go is the C<$^H> variable's explanation in
C<perldoc perlvar>.
