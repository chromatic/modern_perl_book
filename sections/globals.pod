...
I don't understand this strategy. What is being replaced? In Modern Perl, we have the /p modifier with gives use the not-so-terrible three, ${^MATCH}, ${^PREMATCH}, and ${^POSTMATCH}. 
