...
use the C<subs> pragma to tell Perl that you you plan to override a builtin,
...
The core pragma C<constant> handles these details for you. The C<Readonly>
...
A final reasonable use of prototypes is to extend Perl's syntax to operate on
...
The prototype of C<$$> forces Perl to pass the sort pairs in C<@_> instead of
the package globals C<$a> and C<$b>.
