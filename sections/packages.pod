...
The scope of a package continues until the next C<package> declaration
or the end of the file, whichever comes first. Perl 5.14 enhanced
C<package> so that you may provide a block which explicitly delineates
