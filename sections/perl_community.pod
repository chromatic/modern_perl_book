...
The Perl 5 Porters (also known as I<p5p>) mailing list is the central point for
Perl 5 development discussion.  See
...
page on Github is Gitpan (U<http://github.com/gitpan/>), which hosts Git
repositories chronicling the complete history of every distribution on the
CPAN.
