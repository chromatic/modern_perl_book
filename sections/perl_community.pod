...
Several well-known Perl hackers write there.  U<http://blogs.perl.org/> is a
newer community site dedicated to blogging about Perl.
...
Many Perl hackers use Github (U<http://github.com/) to host their projectsN<...
including the drafts of this book at
U<http://github.com/chromatic/modern_perl_book/>).  The site is most notable
for Gitpan, a Git repository of the entire history of the CPAN.  See
U<http://github.com/gitpan/>.
...
When Perl mongers aren't at local meetups or conferences or workshops, many
