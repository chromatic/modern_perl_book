...
Use the anonymous reference declaration syntax to declare a nested data
structure:
...
arrow is superfluous. You may omit it for clarity, except for invoking function
references:
...
typos. The C<autovivification> pragma (L<pragmas>) from the CPAN lets you
disable autovivification in a lexical scope for specific types of operations.
