...
The type context of evaluation of a scalar may cause Perl to coerce of the
value of that scalar (L<coercion>).  For example, you may treat the contents of
a scalar as a string, even if you didn't explicitly assign it a string:
