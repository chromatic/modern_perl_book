...
X<Eric Wilhelm>
X<CPAN; configuration>
X<CPAN; troubleshooting>

Eric Wilhelm's excellent tutorial on configuring the CPAN
...
C<App::perlbrew> is a system to manage and to switch between your own installatoins of multiple versions and configurations of Perl.
