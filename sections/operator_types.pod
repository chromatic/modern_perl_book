...
X<operators; ==>
X<==; numeric comparison operator>
X<operators; !=>
X<!=; numeric comparison operator>
X<< operators; E<gt> >>
X<< E<gt>; numeric comparison operator >>
X<< operators; E<lt> >>
X<< E<lt>; numeric comparison operator >>
X<< operators; E<gt>= >>
X<< E<gt>=; numeric comparison operator >>
X<< operators; E<lt>= >>
X<< E<lt>=; numeric comparison operator >>
X<< operators; E<lt>=E<gt> >>
X<< E<lt>=E<gt>; numeric comparison operator >>
...
X<operators; eq>
X<eq; string comparison operator>
X<operators; ne>
X<ne; string comparison operator>
X<operators; gt>
X<gt; string comparison operator>
X<operators; lt>
X<lt; string comparison operator>
X<operators; ge>
X<ge; string comparison operator>
X<operators; le>
X<le; string comparison operator>
X<operators; cmp>
X<cmp; string comparison operator>
...
X<< E<lt>E<lt>; bitwise operator >>
X<< operators; E<gt>E<gt> >>
X<< E<gt>E<gt>; bitwise operator >>
X<operators; &>
X<&; bitwise operator>
X<operators; |>
X<|; bitwise operator>
