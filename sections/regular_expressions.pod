...
Other modifiers include C</m>, the multiline operator.  When this is active,
the C<^> and C<$> anchors match at any start of line or end of line within the
string, depending on your newline settings.
...
/g - \G, use of assertions without consuming position
/e
