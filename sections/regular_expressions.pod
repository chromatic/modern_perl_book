...
Alternately, you could express that the C<cat> must always occur immediately
after a space character with the I<zero-width positive look-behind assertion>:
