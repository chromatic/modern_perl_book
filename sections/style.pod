...
I<Remove duplication.> Bugs lurk in sections of repeated and similar
...
I<Name entities well.> Your code tells a story. Every name you choose
...
I<Avoid unnecessary cleverness.> Concise code is good, when it reveals
...
I<Embrace simplicity.> If everything else is equal, a simpler program
...
the CPAN. Pay attention, and gain enlightenment on the tradeoffs between
various ideals and styles.
...
I<Follow community norms.> Perl is a community of toolsmiths. We solve broad
...
I<Write testable code.> Writing an effective test suite exercises the
...
I<Modularize.> Enforce encapsulation and abstraction boundaries. Find
...
I<Exploit the CPAN.> Perl programmers solve problems. Then we share
