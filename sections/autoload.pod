...
certain methods in one object to another object somehow available to the
former. A logging proxy can help with debugging:
...
Forward declarations are useful only in the two rare cases of attributes and
