...
wrong, just as the incorrect gender of "la gato"N<The article is feminine, but
...
sentence "Perl are a fun language"N<In terms of amount context, you could say
