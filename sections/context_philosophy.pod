...
X<context>
[While reading this section I figured out that context in Perl is based on what
operators you use and where you use them.  You never directly say this in this
section, or in the operator_types.pod section.  But it's true.  I attempted to
directly say this in this section somewhere, but I couldn't decide where or how,
so this is just a suggestion then.]
...
=head3 Void, Scalar, and List Context
...
=head3 Numeric, String, and Boolean Context
