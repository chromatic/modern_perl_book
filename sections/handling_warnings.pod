...
=head3 Producing Warnings

=for author

warn
Carp carp() and cluck()
do they work with $SIG{__WARN__}?  Must verify.

=end for

=head3 Enabling and Disabling Warnings
...
=head3 Disabling Warning Categories
...
=head3 Registering Your Own Warnings
