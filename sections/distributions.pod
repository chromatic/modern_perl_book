...
measure with heuristics.  Kwalitee is the machine measurable relative of
quality.> of all CPAN distributions and recommends improvements to make them
easier to install and to manage.)
...
away common tasks.  It can replace the direct use of C<Module::Build> or
