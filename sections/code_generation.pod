...
uses less memory by reusing the I<same> compiled code for the bodies of the two
functions.  All that differs is the binding to the C<$attrname> lexical.  In a
...
similar code, as they assign and generate in a single line:
