...
=head3 Overloading Common Operations
...
=head3 Overload and Inheritance
...
I<name> of a method to call to perform the overloading, rather than hard-coding
...
Damian Conway's I<Perl Best Practices> suggsts that the other useful use of
