...
explains the copious methods they support, as you can read or write multiple values from them, among other operations.

=head4 When to use Tied Variables

Tied variables seem like fun opportunities for cleverness, but they make for
conusing interfaces in almost all cases, as developers encounter them so
