...
well-documented interface for the specific data type.  C<perldoc perltie> is the
...
The C<Tie::StdScalar>, C<Tie::StdArray>, and C<Tie::StdHash> are classes from
which to inherit if you implement your own ties.  Their documentation is in the
C<Tie::Scalar>, C<Tie::Array>, and C<Tie::Hash> modules, respectively, as are
