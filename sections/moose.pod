...
Perl's default object system is but minimal but flexible. Its syntax is a
...
each unique object--you may hear this data called I<attributes>, I<instance
data>, or object I<state>. Define an attribute by declaring it as part of the
class:
...
Moose provides many features beyond Perl's default OO. While you I<can> build
