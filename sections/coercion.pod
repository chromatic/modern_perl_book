...
Instead, it I<adds> a stringified value to the internal representation, which
then contains I<both> components. Similarly, numifying a string value populates
the numeric component while leaving the string component untouched.
