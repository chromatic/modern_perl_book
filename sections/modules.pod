...
sense to unimport a pragma, as they often have compilation-time effects.
...
=head3 Organizing Code with Modules

Perl 5 does not require you to use modules, nor package, nor namespaces.  You
