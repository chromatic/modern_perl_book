...
does not explicitly handle this exception, the exception will propogate upwards
...
programs can recover from them, or at least save their state and exit more
cleanly.
...
C<eval> block elsewhere and reset $@.
