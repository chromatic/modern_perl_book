...
I<Modern Perl> is a mindset. It's an approach to writing great software with
the Perl programming language. It's how effective Perl programmers write
...
You'll benefit most from this book if you have some experience with Perl or
another programming language already. If you're comfortable writing and
executing programs (and happy to consult the documentation when it's
mentioned), you'll get the most from this book.
...
At the time of writing, the current stable major Perl release is Perl 5.32. If
...
5.16.0 or newer, though we recommend at least Perl 5.26. While the term "Modern
...
Though Perl comes pre-installed on many operating systems, you may need to
...
U<https://platform.activestate.com/featured-projects>. Users of other operating
systems with Perl already installed (and a C compiler and the other development
tools), start by installing the CPAN module
C<App::perlbrew>N<U<http://search.cpan.org/perldoc?App::perlbrew>>.

=begin sidebar All-in-One Modern Perl 5.32 Installation

As of 2020, ActiveState has a one-liner installation for Perl 5.32 and all of
the CPAN distributions mentioned in this book.

Windows users, see the instructions at U<https://platform.activestate.com/chromatic/ModernPerl4e-5.32-Windows/>.

Linux users, see the instructions at U<https://platform.activestate.com/chromatic/ModernPerl4e-5.32-Linux/>.

Mac users, stay tuned.
