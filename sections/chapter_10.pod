...
Prepare for the second learning curve of Perl: thinking Perlishly through the
effective use of common patterns of behavior and builtin shortcuts which, when
used well, allow you to write concise, powerful code.
